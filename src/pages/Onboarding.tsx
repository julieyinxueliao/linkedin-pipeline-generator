            ...
            {!briefLoading && brief && (
              <>
                ...
                <div className="flex gap-3 pt-4">
                  ...
                  <Button variant="outline" className="border-primary-foreground/15 text-primary-foreground/70 hover:text-primary-foreground hover:bg-primary-foreground/5" onClick={() => { setAiBrief(null); setEditablePovBank(null); }}>Regenerate</Button>
